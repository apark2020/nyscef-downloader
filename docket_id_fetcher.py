...
def get_new_session_id():
    print('You need to provide a new JSESSIONID. Go to https://iapps.courts.state.ny.us/nyscef/NyscefReCaptcha, complete the captcha, then find the JSESSIONID under Inspect > Applications')
